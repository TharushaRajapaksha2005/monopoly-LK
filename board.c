...
void initializeProperties(GameplayState *game)
{
       ...
       game->properties[1].purchasePrice = 1500;
       game->properties[1].mortgageValue = 750;
       game->properties[1].baseRent = 0;
       ...
       game->properties[3].purchasePrice = 2500;
       game->properties[3].mortgageValue = 1250;
       game->properties[3].baseRent = 0;
       ...
       game->properties[4].purchasePrice = 2500;
       game->properties[4].mortgageValue = 1250;
       game->properties[4].baseRent = 0;
       ...
       game->properties[6].purchasePrice = 3500;
       game->properties[6].mortgageValue = 1750;
       game->properties[6].baseRent = 0;
       ...
       game->properties[7].purchasePrice = 3500;
       game->properties[7].mortgageValue = 1750;
       game->properties[7].baseRent = 0;
       ...
       game->properties[9].purchasePrice = 4500;
       game->properties[9].mortgageValue = 2250;
       game->properties[9].baseRent = 0;
       ...
       game->properties[10].purchasePrice = 4500;
       game->properties[10].mortgageValue = 2250;
       game->properties[10].baseRent = 0;
       ...
       game->properties[12].purchasePrice = 5500;
       game->properties[12].mortgageValue = 2750;
       game->properties[12].baseRent = 0;
       ...
       game->properties[13].purchasePrice = 5500;
       game->properties[13].mortgageValue = 2750;
       game->properties[13].baseRent = 0;
       ...
       game->properties[15].purchasePrice = 6500;
       game->properties[15].mortgageValue = 3250;
       game->properties[15].baseRent = 0;
       ...
       game->properties[16].purchasePrice = 6500;
       game->properties[16].mortgageValue = 3250;
       game->properties[16].baseRent = 0;
       ...
       game->properties[18].purchasePrice = 8000;
       game->properties[18].mortgageValue = 4000;
       game->properties[18].baseRent = 0;
       ...
       game->properties[19].purchasePrice = 8000;
       game->properties[19].mortgageValue = 4000;
       game->properties[19].baseRent = 0;
       ...
       game->properties[21].purchasePrice = 10000;
       game->properties[21].mortgageValue = 5000;
       game->properties[21].baseRent = 0;
...
{
       game->railway[0].railwayId = 0;
       strcpy(game->railway[0].name,
              "Colombo Fort Railway Station");
       game->railway[0].purchasePrice = 0;
       game->railway[0].mortgageValue = 0;
       game->railway[0].owner = NO_OWNER;
       game->railway[0].mortgaged = 0;

       game->railway[1].railwayId = 1;
       strcpy(game->railway[1].name,
              "Kandy Railway Station");
       game->railway[1].purchasePrice = 0;
       game->railway[1].mortgageValue = 0;
       game->railway[1].owner = NO_OWNER;
       game->railway[1].mortgaged = 0;

       game->railway[2].railwayId = 2;
       strcpy(game->railway[2].name,
              "Galle Railway Station");
       game->railway[2].purchasePrice = 0;
       game->railway[2].mortgageValue = 0;
       game->railway[2].owner = NO_OWNER;
       game->railway[2].mortgaged = 0;

       game->railway[3].railwayId = 3;
       strcpy(game->railway[3].name,
              "Jaffna Railway Station");
       game->railway[3].purchasePrice = 0;
       game->railway[3].mortgageValue = 0;
       game->railway[3].owner = NO_OWNER;
       game->railway[3].mortgaged = 0;
}
...
void initializeUtilities(GameplayState *game)
{
       ...
       game->utilities[0].purchasePrice = 0;
       ...
       game->utilities[1].purchasePrice = 0;
